...
function AddSac() { // Change the component name to AddSac
    ...
    const handleSubmit = (e) => {
        ...
        axios.post("http://localhost:3001/sacsamain", newProduct)
            .then(res => {
                console.log(res);
                navigate("/sac");
            })
    ...
    return (
        <div className="container">
            <h2 style={{ color: "pink" }}>Ajout d'un sac</h2>
...
export default AddSac; // Change the export name to AddSac

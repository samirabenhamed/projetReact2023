...
function EditCeinture() { // Change the component name to EditCeinture
    ...
    useEffect(() => {
        axios.get('http://localhost:3001/ceintures/' + id).then(res => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.put("http://localhost:3001/ceintures/" + id, newProduct)
            .then(res => {
                console.log(res);
                navigate("/articles");
            })
    ...
    return (
        <>
            <div className="container">
                <h2>Modification d'une ceinture</h2>
...
export default EditCeinture; // Change the export name to EditCeinture

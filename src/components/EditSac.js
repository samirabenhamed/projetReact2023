...
function EditSac() { // Change the component name to EditSac
    ...
    useEffect(() => {
        axios.get('http://localhost:3001/sacsamain/' + id).then(res => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.put("http://localhost:3001/sacsamain/" + id, newProduct)
            .then(res => {
                console.log(res);
                navigate("/articles");
            })
...
export default EditSac; // Change the export name to EditSac
